...
import { resolveComponent, createElementBlock as createElementBlock3, openBlock as openBlock3, mergeProps as mergeProps3, createVNode, renderSlot, createCommentVNode, createElementVNode as createElementVNode3, createBlock, resolveDynamicComponent, toDisplayString, withCtx, Transition } from "vue";
var script$1 = {
  name: "BasePassword",
  "extends": script3,
  props: {
...
function render3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock3(), createElementBlock3("div", mergeProps3({
  ...
  }, _ctx.ptmi("root")), [createVNode(_component_InputText, mergeProps3({
    ref: "input",
    id: _ctx.inputId,
  ...
  }), null, 16, ["id", "type", "class", "style", "defaultValue", "name", "aria-labelledby", "aria-label", "aria-controls", "placeholder", "required", "fluid", "disabled", "variant", "invalid", "size", "autofocus", "onInput", "onFocus", "onBlur", "onKeyup", "onInvalid", "data-p-has-e-icon", "pt", "unstyled"]), _ctx.toggleMask && $data.unmasked ? renderSlot(_ctx.$slots, _ctx.$slots.maskicon ? "maskicon" : "hideicon", mergeProps3({
    key: 0,
    toggleCallback: $options.onMaskToggle,
    "class": [_ctx.cx("maskIcon"), _ctx.maskIcon]
  }, _ctx.ptm("maskIcon")), function() {
    return [(openBlock3(), createBlock(resolveDynamicComponent(_ctx.maskIcon ? "i" : "EyeSlashIcon"), mergeProps3({
      "class": [_ctx.cx("maskIcon"), _ctx.maskIcon],
      onClick: $options.onMaskToggle
    }, _ctx.ptm("maskIcon")), null, 16, ["class", "onClick"]))];
  }) : createCommentVNode("", true), _ctx.toggleMask && !$data.unmasked ? renderSlot(_ctx.$slots, _ctx.$slots.unmaskicon ? "unmaskicon" : "showicon", mergeProps3({
    key: 1,
    toggleCallback: $options.onMaskToggle,
    "class": [_ctx.cx("unmaskIcon")]
  }, _ctx.ptm("unmaskIcon")), function() {
    return [(openBlock3(), createBlock(resolveDynamicComponent(_ctx.unmaskIcon ? "i" : "EyeIcon"), mergeProps3({
      "class": [_ctx.cx("unmaskIcon"), _ctx.unmaskIcon],
      onClick: $options.onMaskToggle
    }, _ctx.ptm("unmaskIcon")), null, 16, ["class", "onClick"]))];
  }) : createCommentVNode("", true), createElementVNode3("span", mergeProps3({
    ...
    "default": withCtx(function() {
      return [createVNode(Transition, mergeProps3({
        ...
        "default": withCtx(function() {
          return [$data.overlayVisible ? (openBlock3(), createElementBlock3("div", mergeProps3({
            key: 0,
            ...
            }, _ctx.ptm("content")), [createElementVNode3("div", mergeProps3({
              "class": _ctx.cx("meter")
            }, _ctx.ptm("meter")), [createElementVNode3("div", mergeProps3({
              "class": _ctx.cx("meterLabel"),
              style: {
                width: $data.meter ? $data.meter.width : ""
              },
              "data-p": $options.meterDataP
            }, _ctx.ptm("meterLabel")), null, 16, _hoisted_3)], 16), createElementVNode3("div", mergeProps3({
