...
import { resolveComponent, createElementBlock as createElementBlock2, openBlock as openBlock2, mergeProps as mergeProps2, createVNode, createCommentVNode, renderSlot, normalizeStyle, normalizeClass, createElementVNode as createElementVNode2, toHandlers, createBlock, resolveDynamicComponent } from "vue";
var script$1 = {
...
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock2(), createElementBlock2("span", mergeProps2({
    ...
    "data-p": $options.dataP
  }, null, 8, ["id", "name", "class", "style", "defaultValue", "aria-valuemin", "aria-valuemax", "aria-valuenow", "inputmode", "disabled", "readonly", "placeholder", "aria-labelledby", "aria-label", "required", "size", "invalid", "variant", "onInput", "onKeydown", "onKeypress", "onPaste", "onClick", "onFocus", "onBlur", "pt", "unstyled", "data-p"]), _ctx.showButtons && _ctx.buttonLayout === "stacked" ? (openBlock2(), createElementBlock2("span", mergeProps2({
    key: 0,
    ...
    return [createElementVNode2("button", mergeProps2({
      ...
      return [(openBlock2(), createBlock(resolveDynamicComponent(_ctx.incrementIcon || _ctx.incrementButtonIcon ? "span" : "AngleUpIcon"), mergeProps2({
    ...
    return [createElementVNode2("button", mergeProps2({
      ...
      return [(openBlock2(), createBlock(resolveDynamicComponent(_ctx.decrementIcon || _ctx.decrementButtonIcon ? "span" : "AngleDownIcon"), mergeProps2({
    ...
    return [_ctx.showButtons && _ctx.buttonLayout !== "stacked" ? (openBlock2(), createElementBlock2("button", mergeProps2({
      key: 0,
      "class": [_ctx.cx("incrementButton"), _ctx.incrementButtonClass]
    }, toHandlers($options.upButtonListeners, true), {
      disabled: _ctx.disabled,
...
//# sourceMappingURL=chunk-BVC34GP2.js.map
