...
import { resolveComponent, createElementBlock as createElementBlock3, openBlock as openBlock3, mergeProps as mergeProps3, createVNode, createCommentVNode, renderSlot, normalizeStyle, normalizeClass, createElementVNode as createElementVNode3, toHandlers, createBlock, resolveDynamicComponent } from "vue";
var script$1 = {
...
function render3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock3(), createElementBlock3("span", mergeProps3({
    ...
    "data-p": $options.dataP
  }, null, 8, ["id", "name", "class", "style", "defaultValue", "aria-valuemin", "aria-valuemax", "aria-valuenow", "inputmode", "disabled", "readonly", "placeholder", "aria-labelledby", "aria-label", "required", "size", "invalid", "variant", "onInput", "onKeydown", "onKeypress", "onPaste", "onClick", "onFocus", "onBlur", "pt", "unstyled", "data-p"]), _ctx.showButtons && _ctx.buttonLayout === "stacked" ? (openBlock3(), createElementBlock3("span", mergeProps3({
    key: 0,
    ...
    return [createElementVNode3("button", mergeProps3({
      ...
      return [(openBlock3(), createBlock(resolveDynamicComponent(_ctx.incrementIcon || _ctx.incrementButtonIcon ? "span" : "AngleUpIcon"), mergeProps3({
    ...
    return [createElementVNode3("button", mergeProps3({
      ...
      return [(openBlock3(), createBlock(resolveDynamicComponent(_ctx.decrementIcon || _ctx.decrementButtonIcon ? "span" : "AngleDownIcon"), mergeProps3({
    ...
    return [_ctx.showButtons && _ctx.buttonLayout !== "stacked" ? (openBlock3(), createElementBlock3("button", mergeProps3({
      key: 0,
      "class": [_ctx.cx("incrementButton"), _ctx.incrementButtonClass]
    }, toHandlers($options.upButtonListeners, true), {
      disabled: _ctx.disabled,
...
//# sourceMappingURL=chunk-BFS77D6U.js.map
