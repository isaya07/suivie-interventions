      ...
      <div class="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="text-center">
          <div class="bg-white rounded-lg p-6 shadow-lg">
            ...
            <h3 class="text-lg font-medium text-gray-900 mb-2">Gestion des missions</h3>
            <p class="text-gray-600">Créez, assignez et suivez toutes vos interventions techniques.</p>
          </div>
        </div>
        ...
        <div class="text-center">
          <div class="bg-white rounded-lg p-6 shadow-lg">
            ...
            <h3 class="text-lg font-medium text-gray-900 mb-2">Équipe</h3>
            <p class="text-gray-600">Gérez vos techniciens et optimisez leur planning.</p>
          </div>
        </div>
        ...
        <div class="text-center">
          <div class="bg-white rounded-lg p-6 shadow-lg">
            ...
            <p class="text-gray-600">Analysez les performances et générez des rapports détaillés.</p>
          </div>
        </div>
      </div>
    </div>
